...
- **The type pairing is a *decision*, not an A/B.** A stylescape commits: name the **headline** face and the **supporting** face and show them doing their jobs. Do **not** put a typeface switcher / tabs to "compare options" on the board — deciding is the work; a switcher just punts it to the client.
