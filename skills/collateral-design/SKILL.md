...
- [ ] **Logo placed as the one locked asset** — never rebuilt, recoloured, boxed, cropped, or re-proportioned; identical behaviour in every medium
- [ ] **No invented elements** — every graphic traces to `design.md`; nothing added "just for print"
- [ ] **Not everything in a card** — structure led by type, column headers and space
